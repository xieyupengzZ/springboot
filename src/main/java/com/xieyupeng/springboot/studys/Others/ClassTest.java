...
public class ClassTest {
    ...
    static
    {
        System.out.println("1-静态代码块");//TODO static修饰的，都是按代码的顺序执行
    }

    static ClassTest st = new ClassTest(); //TODO 初始化对象（先属性赋值，再代码块，再构造方法，此时并不会执行其他静态的代码）

    static
    {
        //TODO 第三个static修饰的，第三个执行，此处看下b的值，也就能知道 b的赋值操作没有执行（此处直接调用 b 编译不通过，要通过st来调用，因为st已经初始化了）
//        System.out.println("2:"+b);
        System.out.println("2-静态代码块:"+st.b);
    }

    {
        System.out.println("3-代码块:"); //TODO 初始化st的时候，执行了该代码块
    }
